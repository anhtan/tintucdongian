                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <?php echo form_open_multipart(base_url_admin().'navigation/editNavigation/'.$update_info[0]->menu_client_id.'',$attributes); ?>

                            <div class="form-group">
                                <input class="form-control" name="menu_client_id" value="<?php echo $update_info[0]->menu_client_id; ?>" type="hidden" />
                                <input type="hidden" class="path_category_article" name="" value="">
                            </div>

                            <div class="form-group">
                                <label> Tên menu <span class="asterik_label"> (*)</span></label>
                                <input class="input_normal form-control article_category_name" name="menu_client_name" placeholder="Nhập Tên menu"  value="<?php echo $update_info[0]->menu_client_name; ?>" type="text">
                                <?php echo form_error('menu_client_name','<p class="help-block mess_required">','</p>'); ?>
                            </div>

                            <div class="form-group">
                                <label> Bí danh <span class="asterik_label"> (*)</span></label>
                                <input class="input_alias form-control article_category_name" name="menu_client_alias" placeholder="Nhập Bí danh"  value="<?php echo $update_info[0]->menu_client_alias; ?>" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <input class="input_path form-control article_category_name" name="menu_client_path" placeholder="Nhập Đường dẫn"  value="<?php echo $update_info[0]->menu_client_path; ?>" type="text">
                                ...
                                <select name="menu_client_parent" class="form-control">
                                    <option value="0">Chọn danh mục</option>
                                        <?php foreach($list_parent as $s_list_parent): ?>
                                            <option <?php if($s_list_parent->menu_client_id == $update_info[0]->menu_client_parent){echo "selected";} ?> value="<?php echo $s_list_parent->menu_client_id; ?>"><?php echo $s_list_parent->menu_client_name; ?></option>
                                        <?php endforeach; ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control medium_input" name="menu_client_status">
                                    ...
                                    <?php foreach($arr_status as $key=>$value): ?>
                                        <option  <?php if($update_info[0]->menu_client_status == $key){echo "selected";} ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                    <?php endforeach; ?>
                                </select>
