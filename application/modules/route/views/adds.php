                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <?php echo form_open_multipart(base_url_admin().'route/addRoute',$attributes); ?>
...
<div class="form-group">
    ...
    <input class="input_normal form-control article_category_name" name="route_old" placeholder="Nhập Đường dẫn gốc"  value="<?php if(set_value("route_old")){echo set_value("route_old");} ?>" type="text">
    <?php echo form_error('route_old','<p class="help-block mess_required">','</p>'); ?>
</div>

<div class="form-group">
    <label> Đường dẫn mới <span class="asterik_label"> (*)</span></label>
    <input class="input_normal form-control article_category_name" name="route_new" placeholder="Nhập Đường dẫn mới"  value="<?php if(set_value("route_new")){echo set_value("route_new");} ?>" type="text">
...
<div class="form-group">
    ...
    <input class="input_normal form-control article_category_name" name="route_object" placeholder="Nhập Đối tượng route"  value="<?php if(set_value("route_object")){echo set_value("route_object");} ?>" type="text">
