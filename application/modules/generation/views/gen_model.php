        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <input type="hidden" class="type_gen" value="1"/>
                            <?php echo form_open_multipart(base_url_admin().'generation/genModel'); ?>
                            <div class="get_info_model">
                                <div class="form-group">
                                    <label>Tên model <span class="asterik_label"> (*)</span></label>
                                    <input class="input_normal form-control article_category_name get_name_model" name="" value="<?php if(isset($name_module_model)){echo $name_module_model;} ?>" type="text">
