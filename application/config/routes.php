...
//-------------- module route--------------
$route['admin/route/listRoute'] = "route/listRoute";
$route['admin/route/changeStatus'] = "route/changeStatus";
$route['admin/route/loadRoute'] = "route/loadRoute";
$route['admin/route/viewDetail'] = "route/viewDetail";
$route['admin/route/addRoute'] = "route/addRoute";
$route['admin/route/deleteOne/(:any)'] = "route/deleteOne/$1";
$route['admin/route/editRoute/(:any)'] = "route/editRoute/$1";
$route['admin/route/listOrderByPosition'] = "route/listOrderByPosition";
