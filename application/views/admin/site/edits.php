                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <?php if(isset($update_info[0]->site_id)): ?>
                                <?php $id = '/'.$update_info[0]->site_id; ?>
                            <?php else : ?>
                                <?php $id = ""; ?>
                            <?php endif; ?>

                            <?php echo form_open_multipart(base_url_admin().'site/editSite'.$id.'',$attributes); ?>

<div class="form-group">
    <input class="form-control" name="site_id" value="<?php if(isset($update_info[0]->site_id)){echo $update_info[0]->site_id;}else if(set_value('site_id')){echo set_value("site_id");} ?>" type="hidden" />
</div>
...
<div class="form-group">
    ...
    <select name="site_type" class="form-control">
        ...
        <?php foreach($type_site as $key=>$value): ?>
            <option <?php if($update_info[0]->site_type == $key){echo "selected";} ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
        <?php endforeach; ?>
    </select>
...
<div class="form-group">
    ...
    <select class="form-control medium_input" name="site_status">
        ...
        <?php foreach($arr_status as $key=>$value): ?>
            <option  <?php if($update_info[0]->site_status == $key){echo "selected";} ?>  value="<?php echo $key; ?>"><?php echo $value; ?></option>
        <?php endforeach; ?>
    </select>
