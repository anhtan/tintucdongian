        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <?php echo form_open(base_url_admin().'usersgroup/editUserGroup/'.$users_group_info[0]->users_group_id); ?>
                            <div class="form-group">
                                <input class="form-control" name="users_group_id" value="<?php echo $users_group_info[0]->users_group_id; ?>" type="hidden">
                            </div>
                            <div class="form-group">
                                <label>Tên quyền hạn <span class="asterik_label"> (*)</span></label>
                                <input class="form-control" name="users_group_name" value="<?php if($users_group_info[0]->users_group_name) {echo $users_group_info[0]->users_group_name;}else{ echo set_value('users_group_name');} ?>" type="text">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="users_group_view">
                                    ...
                                    <?php foreach($arr_status as $key=>$value): ?>
                                        <option <?php if($users_group_info[0]->users_group_view == $key){echo "selected"; } ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
