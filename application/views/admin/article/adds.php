                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <?php echo form_open_multipart(base_url_admin().'article/addArticle',$attributes); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="input_path path_article form-control medium_input article_path" value="<?php echo set_value('article_path'); ?>" name="article_path">
