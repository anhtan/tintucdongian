        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                                <?php echo form_open(base_url_admin().'users/addUser'); ?>
                                    <div class="form-group">
                                        <label>Tên thành viên <span class="asterik_label"> (*)</span></label>
                                        <input class="form-control" name="users_name" value="<?php echo set_value('users_name') ?>" type="text">
                                        <?php echo form_error('users_name','<p class="help-block mess_required">','</p>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label>Mật khẩu <span class="asterik_label"> (*)</span></label>
                                        <input type="password" class="form-control" value="<?php echo set_value('users_pass'); ?>" name="users_pass">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" value="<?php echo set_value('users_repeatpass'); ?>" name="users_repeatpass">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo set_value('users_fullname'); ?>" name="users_fullname">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php echo set_value('users_email'); ?>" name="users_email">
                                        <?php echo form_error('users_email','<p class="help-block mess_required">','</p>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label>Địa chỉ <span class="asterik_label"> (*)</span></label>
                                        <input class="form-control" name="users_address" type="text">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="users_group_id" class="form-control">
                                            ...
                                            <?php foreach($users_group_info as $s_users_group_info): ?>
                                                <option <?php if($s_users_group_info->users_group_id == set_value('users_group_id')){ echo "selected"; } ?> value="<?php  echo $s_users_group_info->users_group_id; ?>"><?php echo $s_users_group_info->users_group_name; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="users_active">
                                            ...
                                            <?php foreach($arr_status as $key=>$value): ?>
                                                <option <?php if($key == set_value('users_active')){echo "selected"; } ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
                                            <?php endforeach; ?>
                                        </select>
